...
<!-- OSS_CONTRIBUTIONS:START -->## 🧩 Open Source Contributions:
...
[View remaining 81 PRs](https://github.com/sindresorhus/type-fest/pulls?q=is%3Apr%20is%3Aclosed%20author%3Asom-sm)### ts-essentials/ts-essentials
...
- **Fix: Behaviour of `OptionalKeys` when instantiated with primitives and arrays** — [#414](https://github.com/ts-essentials/ts-essentials/pull/414)### orta/vscode-twoslash-queries
...
- **Add command for inline comment (// =>)** — [#41](https://github.com/orta/vscode-twoslash-queries/pull/41)### sindresorhus/eslint-plugin-unicorn
...
- **Add more test cases for `prefer-string-raw` rule** — [#2690](https://github.com/sindresorhus/eslint-plugin-unicorn/pull/2690)### xojs/xo
- **Fix: Behaviour of `print-config` option with relative file path** — [#816](https://github.com/xojs/xo/pull/816)
- **Fix: Error while loading configs with custom plugins** — [#805](https://github.com/xojs/xo/pull/805)### DavidHDev/haiku
- **Fix `useLeaveDetection` to always invoke latest callback** — [#123](https://github.com/DavidHDev/haiku/pull/123)<!-- OSS_CONTRIBUTIONS:END -->
